angular.module('quickRabbit.tasks').controller('viewTasksCtrl', viewTasksCtrl);

viewTasksCtrl.$inject = ['TasksServiceResolve', 'TasksService', '$scope', 'toastr'];

function viewTasksCtrl(TasksServiceResolve, TasksService, $scope, toastr) {
