angular.module('quickRabbit.categories').controller('categoryListCtrl', categoryListCtrl);

categoryListCtrl.$inject = ['CategoryServiceResolve', 'CategoryService', '$scope'];

function categoryListCtrl(CategoryServiceResolve, CategoryService, $scope) {
    var tlc = this;
    ...
    var layout = [
        ...
        {
            name: 'Actions',
            template: '<button class="btn btn-info btn-rounded btn-ef btn-ef-5 btn-ef-5b" ng-if="options.permission.edit != false" ui-sref="app.categories.edit({id:content._id})"><i class="fa fa-edit"></i> <span>Edit</span></button>' +
