...
usersListCtrl.$inject = ['usersServiceResolve', 'UsersService', '$scope', 'MainService','toastr'];

function usersListCtrl(usersServiceResolve, UsersService, $scope, MainService,toastr) {
