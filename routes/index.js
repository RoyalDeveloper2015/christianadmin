        ...
        app.get('/*', function (req, res) {
            ...
            if (req.session.passport) {
                if (Object.keys(req.session.passport).length == 0) {
                    res.clearCookie('siteglobals');
                    res.clearCookie('username');
                    res.clearCookie('TaskerData');
                }
            }
            */
